...
import com.bang.composable_graphs.util.DEFAULT_GRAPH_PADDING
...
fun MyBarGraph(
    ...
    formatData: (Number) -> String = { it.toString() }
) {
    BarGraphImpl(
        modifier = modifier,
        ...
        style = style,
        onBarClick = onBarClick,formatData
    )
}
...
private fun BarGraphImpl(
    ...
    Canvas(modifier = modifier.then(defaultModifier)) {
         ...
         */
        barGraphHelper.drawBars(yAxisData, barOffsetList, formatData)
