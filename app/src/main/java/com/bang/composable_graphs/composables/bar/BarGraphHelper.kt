package com.bang.composable_graphs.composables.bar
...
import com.bang.composable_graphs.composables.bar.style.BarGraphFillType
import com.bang.composable_graphs.composables.bar.style.BarGraphStyle
import com.bang.composable_graphs.style.LabelPosition
import com.bang.composable_graphs.theme.LightGray
import com.bang.composable_graphs.util.GraphHelper
import com.bang.composable_graphs.util.logDebug
    ...
    internal fun drawBars(
        ...
        scope.run {
            metrics.offsetList.forEach { offsetPair ->
                ...
                val data = yAxisData[barOffsetList.indexOf(offsetPair)]
                // 添加在此处绘制 bar 的顶部文字
                drawContext.canvas.nativeCanvas.drawText(
                    formatData(data),
                    offset1.x + metrics.xItemSpacing / 2, // x
                    offset1.y - 10, // y
                    Paint().apply {
